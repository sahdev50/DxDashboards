...
exports.getOtpEmailTemplate = (name, otp) => {
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border-radius: 10px; background: #f9f9f9; color: #333;">
        ...
        <p style="color: #aaa;">— Dx-Dashboards Team</p>
      </div>
    `;
  };
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 30px; border-radius: 10px;">
    ...
    <p>We’re excited to let you know that your email has been <strong>successfully verified</strong> on <strong>Dx-Dashboards</strong>.</p>
    <p>You can now access all features and start creating your own dashboards like a pro 💼.</p>
    ...
    <p style="font-size: 14px; color: #888;">If you didn’t create an account on Dx-Dashboards , you can ignore this email.</p>
    <p style="font-size: 14px; color: #888;">Need help? Contact us at support@dxdashboards.com</p>
  </div>
`;
